...
public class Forex_steps extends BaseTestFortradeR {
    ...
    public void urlAssert() throws IOException, AWTException {
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
        fortradeRPage.assertURL("https://www.fortrader.com/minilps/en/forex-steps/");
    ...
    public void checkingTagsInTheCrm() throws IOException, AWTException {
        String email = TestData.emailGenerator();
        String phoneNumber = TestData.phoneNumberGenerator();
        driver.get("https://www.fortrader.com/minilps/en/forex-steps/?tg=ivanA1389&tag1=ivanB@1389&tag2=ivanL1389&" +
    ...
    public void checkingForLogoClickability() throws IOException, AWTException {
        FortradeRPage fortradeRPage = new FortradeRPage(driver);
        fortradeRPage.checkLogoClickability("https://www.fortrader.com/minilps/en/forex-steps/");
